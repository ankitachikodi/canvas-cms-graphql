                ...
                >
                  {
                    mutation => (
                      <div className="col-6">
                        <button onClick={mutation} className="btn btn-default profile-content-contianer-footer-button" label="Update">
                          <span className="profile-content-contianer-footer-button-text">Update Profile</span>
                        </button>
                      </div>
                    )
                  }
